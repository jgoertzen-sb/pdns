...
global_zone_command : ZONETOK quotedname zone_block
{
  s_di.name = DNSName($2);
  free($2);
  parent->commit(s_di);
...
global_options_command : OPTIONSTOK OBRACE options_commands EBRACE
                         | LOGGINGTOK OBRACE options_commands EBRACE;

acl_command : ACLTOK quotedname acl_block | ACLTOK filename acl_block;

acl_block : OBRACE acls EBRACE;

acls : | acl SEMICOLON acls;

acl : AWORD;

options_commands : | options_command SEMICOLON options_commands;
...
also_notify_list : | also_notify SEMICOLON also_notify_list;
...
block : OBRACE commands EBRACE;

zone_block : OBRACE zone_commands EBRACE;

zone_commands : | zone_commands zone_command SEMICOLON;
...
zone_also_notify_list : | zone_also_notify SEMICOLON zone_also_notify_list;
...
zone_file_command : FILETOK quotedname
{
...
zone_type_command : TYPETOK AWORD
{
  s_di.type = $2;
  free($2);
};
